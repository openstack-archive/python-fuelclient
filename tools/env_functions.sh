...
function prepare_fuelclient_config {
    echo "Creating fuelclient config file $FUELCLIENT_CONFIG"
    cat > $FUELCLIENT_CONFIG <<EOL
...
function cleanup_fuelclient_config {
    echo "Removing fuelclient config file $FUELCLIENT_CONFIG"
    rm -f $FUELCLIENT_CONFIG
}

    ...
    def __init__(self, argv):
        ...
        self.parser = argparse.ArgumentParser(
            ...
            DEPRECATION WARNING:
                ...
                The table bellow specifies the commands which are going to be
                ...
                This list, however, may be changed potentially so it's
                recommended to keep tuned it.

                To check out how ther new Fuel Client will look like, it's
                possible to use the preview version:

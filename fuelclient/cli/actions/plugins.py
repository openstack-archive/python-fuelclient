...
class PluginAction(Action):
    ...
    def install(self, params):
        """Install or upgrade plugin and register it in API service.
            Upgrade plugin is allowed from one minor version to another:
            2.0.0 -> 2.0.1 - allowed
            2.0.0 -> 2.1.0 - cannot be used to perform upgrade, a new version
                of a plugin will be installed

              fuel plugins --install plugin-name-2.0-2.0.1-0.noarch.rpm

            To reinstall plugin with the same version or downgrade plugin
            need to use '--force' flag:
            Downgrade plugin is allowed from one minor version to another:
            2.0.1 -> 2.0.0 - allowed
            2.0.1 -> 1.0.0 - cannot be used to perform downgrade, a new version
                of a plugin will be installed

              fuel plugins --install plugin-name-2.0-2.0.1-0.noarch.rpm --force

            Note: upgrade and downgrade is supported for plugins beginning from

...
class NodeAction(Action):
    ...
    def _check_only_one_node_selected(self, params):
        """Check if only one node was passed in the command and returns it.
    ...
    def set_name(self, params):
        ...
        """
        node = self._check_only_one_node_selected(params)

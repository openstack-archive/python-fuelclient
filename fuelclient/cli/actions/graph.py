...
class GraphAction(base.Action):
    ...
    def download(self, params):
        ...
        Sepcify output dir:
        fuel graph --env 1 --download --dir outpup/dir/
        ...
        filename = 'deployment_graph'
        for param in ('start', 'end', 'parents-for'):
            filename = '{0}_{1}_{2}'.format(filename,

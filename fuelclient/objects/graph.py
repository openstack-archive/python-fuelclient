...
class Graph(BaseObject):
    ...
    related_graph_api_path = \
        "{related_model}/{related_model_id}/deployment_graphs/{graph_type}"

    merged_cluster_tasks_api_path = \
        "clusters/{cluster_id}/deployment_tasks/?graph_type={graph_type}"

    cluster_deploy_api_path =\
    ...
    def read_tasks_data_from_file(cls, file_path=None, serializer=None):
        ...
        return (serializer or cls.serializer).read_from_file(file_path)
    ...
    def write_tasks_to_file(cls, tasks_data, serializer=None, file_path=None):
        # fixme: serializer will not work with class

...
class Operator(object):
    ...
    @staticmethod
    def evaluate(operands_stack, ctx):
...
class NotOperator(Operator):
    ...
    def evaluate(operands_stack, ctx):
        ...
        a = a in ctx if not isinstance(a, bool) else a
        operands_stack.append(not a)
...
class AndOperator(Operator):
    ...
    def evaluate(operands_stack, ctx):
        ...
        b = b in ctx if not isinstance(b, bool) else b
        operands_stack.append(a and b)
...
class FinOperator(Operator):
    ...
    def evaluate(operands_stack, ctx):
        ...
        if len(operands_stack) == 1:
            a = operands_stack.pop()
            operands_stack.append(a in ctx if not isinstance(a, bool) else a)
...
class LabelsFilter(object):
    ...
    def _remove_quotes(string):
        if string[0] is string[-1] and RE_QUOTES_COMP.match(string[0]):
            return string[1: -1]
        else:
            return string

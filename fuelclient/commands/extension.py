...
class EnvExtensionIDMixIn(ExtensionMixIn, base.BaseCommand):

    def get_parser(self, prog_name):
        parser = super(EnvExtensionIDMixIn, self).get_parser(prog_name)
...
class EnvExtensionList(ExtensionMixIn, base.BaseShowCommand):
    """Show list of enabled extensions for environment with given id."""

    help_entity_name = 'cluster'
    columns = ("extensions", )


class EnvExtensionEnable(EnvExtensionIDMixIn):
...
class EnvExtensionDisable(EnvExtensionIDMixIn):

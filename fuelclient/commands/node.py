...
class NodeMixIn(object):
    ...
    allowed_attr_types = ('attribute', 'disks', 'interfaces')
...
class NodeInterfacesDownload(NodeMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        interfaces = self.client.get_interfaces(parsed_args.id)
...
class NodeInterfacesUpload(NodeMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        with open(file_path, 'r') as handle:
            self.client.set_interfaces(parsed_args.id, json.load(handle))

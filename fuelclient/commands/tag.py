...
class BaseUploadCommand(TagMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        msg = ("Description of tag was {action}d to/from"
...
class TagUpdate(BaseUploadCommand):
    ...
    def upload(self, data, parsed_args):
        return self.client.update_tag(data, tag_id=parsed_args.tag_id)
...
class TagCreate(BaseUploadCommand):
    ...
    def upload(self, data, parsed_args):
        return self.client.create_tag(data)
...
class BaseTagAssignee(TagMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.stdout.write('Tags {t} were assigned to/from the node {n}.'
...
class TagAssign(BaseTagAssignee):
    ...
    @property
    def assignee(self):
        return self.client.assign_tags
...
class TagUnassign(BaseTagAssignee):
    ...
    @property
    def assignee(self):
        return self.client.unassign_tags

...
class TagList(TagMixIn, base.BaseListCommand):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            type=str,
            choices=['release', 'cluster', 'plugin'],
            help='Choose tags owner')
        parser.add_argument(
            '-i',
            '--owner_id',
            required=True,
    ...
    def take_action(self, parsed_args):
        data = self.client.get_all(parsed_args.owner, parsed_args.owner_id)
...
class TagUpdate(TagMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        response = self.client.update(parsed_args.tag_id, data)
...
class TagCreate(TagMixIn, base.BaseCommand):
    ...
    def take_action(self, parsed_args):
        ...
        self.client.create(parsed_args.owner, parsed_args.owner_id, data)

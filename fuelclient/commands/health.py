...
class HealthCheckAction(HealthMixIn, base.BaseCommand):
    """Base class for action control of a given test set."""
    ...
    def get_parser(self, prog_name):
        parser = super(HealthCheckAction, self).get_parser(prog_name)
    ...
    def take_action(self, parsed_args):
        ...
        msg = ("Testset '{testset}' with id {t_id} was {action}"
...
class HealthCheckStop(HealthCheckAction):
    """Stop health check procedure for specified test set."""

    action_status = "stopped"


class HealthCheckRestart(HealthCheckAction):
    """Restart health check procedure for specified test set."""

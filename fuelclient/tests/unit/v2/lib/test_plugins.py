...
class TestPluginsFacade(test_api.BaseLibTest):
    ...
    def test_sync_plugins(self):
        ...
        self.assertEqual(None, matcher.request_history[0].body)
    ...
    def test_sync_plugins_empty_ids(self):
        ...
        self.client.sync([])
        self.assertTrue(matcher.called)
        self.assertEqual([], matcher.request_history[0].json()['ids'])
    ...
    def test_sync_specified_plugins(self):
        ...
        self.assertTrue(matcher.called)
        self.assertEqual(ids, matcher.request_history[0].json()['ids'])

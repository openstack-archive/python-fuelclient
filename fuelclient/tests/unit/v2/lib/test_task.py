...
class TestTaskFacade(test_api.BaseLibTest):
    ...
    def test_task_list_w_parameters(self):
        ...
        self.client.get_all(env_id=env_id, statuses=statuses, types=types)

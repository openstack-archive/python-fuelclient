...
class TestNodeCommand(test_engine.BaseCLITest):
    ...
    def test_node_list(self):
        ...
        self.m_client.get_all.assert_called_once_with(
            ...
            online=False, roles=None, status=None)
    ...
    def test_node_list_with_one_role(self):
        ...
        self.m_client.get_all.assert_called_once_with(
            environment_id=None, group_id=None, labels=None, offline=False,
            online=False, roles=[u'controller'], status=None)
    ...
    def test_node_list_with_several_roles(self):
        ...
        self.m_client.get_all.assert_called_once_with(
            environment_id=None, group_id=None, labels=None, offline=False,
            online=False, roles=[u'controller', u'cinder'], status=None)
    ...
    def test_node_list_with_status(self):
        ...
        self.m_client.get_all.assert_called_once_with(
            environment_id=None, group_id=None, labels=None, offline=False,
            online=False, roles=None, status='discover')
    ...
    def test_node_list_with_online(self):
        ...
        self.m_client.get_all.assert_called_once_with(
            environment_id=None, group_id=None, labels=None, offline=False,
            online=True, roles=None, status=None)
    ...
    def test_node_list_with_envid_groupid_role_status_and_online(self):
        ...
        self.m_get_client.assert_called_once_with('node', mock.ANY)
        self.m_client.get_all.assert_called_once_with(
            environment_id=2, group_id=1, labels=None, offline=True,
            online=False, roles=['controller', 'cinder'], status='discover')

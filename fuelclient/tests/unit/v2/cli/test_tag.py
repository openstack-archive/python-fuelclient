...
class TestTagCommand(test_engine.BaseCLITest):
    ...
    def test_tag_update_json(self):
        ...
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.update_tag.assert_called_once_with(tag_data,
                                                         tag_id=tag_id)
    ...
    def test_tag_create_json(self):
        ...
        m_open.assert_called_once_with(expected_path, 'r')
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.create_tag.assert_called_once_with(tag_data)
    ...
    def test_tag_delete(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.delete_tag.assert_called_once_with(tag_id)
    ...
    def test_tag_assign(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.assign_tags.assert_called_once_with(node=node_id,
                                                          tag_ids=tag_ids)
    ...
    def test_tag_unassign(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.unassign_tags.assert_called_once_with(node=node_id,
                                                            tag_ids=tag_ids)

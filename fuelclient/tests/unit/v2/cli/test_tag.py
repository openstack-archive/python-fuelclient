...
class TestTagCommand(test_engine.BaseCLITest):
    ...
    def test_tag_list(self):
        ...
        args = 'tag list -o release -i 2'
        self.exec_command(args)
        self.m_client.get_all.assert_called_once_with('release', 2)
    ...
    def test_tag_create_json(self, m_file_exists):
        ...
        args = 'tag create -o release -i 2 -f {}'.format(tag_path)
        ...
        self.m_get_client.assert_called_once_with('tag', mock.ANY)
        self.m_client.create.assert_called_once_with('release', 2, tag_data)

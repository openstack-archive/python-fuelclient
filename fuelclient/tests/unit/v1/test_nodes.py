...
class TestNodeSetAction(base.UnitTestCase):
    ...
    def test_more_than_one_node(self, mrequests):
        mput = mrequests.put('/api/v1/nodes/{0}/'.format(self.node_id))
    ...
    def test_set_name(self, mrequests):
    ...
    def test_set_hostname(self, mrequests):

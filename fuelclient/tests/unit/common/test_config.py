...
class TestSettings(base.UnitTestCase):
    ...
    def test_config_generation(self, m_exists, m_chmod, m_copy, m_makedirs):
        ...
        f_confdir = fixtures.EnvironmentVariable('XDG_CONFIG_HOME', conf_dir)
        ...
        m_makedirs.assert_called_once_with(conf_dir)
        m_copy.assert_called_once_with(expected_default, expected_path)

        m_chmod.assert_has_calls([mock.call(conf_dir, expected_dmode),
                                  mock.call(expected_path, expected_fmode)])

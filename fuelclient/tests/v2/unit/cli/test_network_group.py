...
class TestNetworkGroupCommand(test_engine.BaseCLITest):
    ...
    def setUp(self):
        ...
        get_fake_ng = fake_network_group.get_fake_netwrok_group
    ...
    def test_network_group_list(self):
        ...
        self.m_get_client.assert_called_once_with('network_group', mock.ANY)
        self.m_client.get_all.assert_called_once_with()

    def test_netwrok_group_create(self):
        ...
        m_client.create.assert_called_once_with(
            ...
            release=32, gateway='10.10.0.1', meta=None)

    def test_netwrok_group_update(self):
        self.m_client.updatable_attributes = \
            NetworkGroupClient.updatable_attributes
        args = 'network-group update -C 10.10.0.0/24 1'
        self.exec_command(args)

        self.m_get_client.assert_called_once_with('network_group', mock.ANY)

        m_client = self.m_client
        m_client.update.assert_called_once_with(1, cidr='10.10.0.0/24')

    def test_netwrok_group_delete(self):

...
class TestSnapshot(base.UnitTestCase):
    ...
    def test_snapshot_with_provided_conf(self, mtty, mread, mbar, mstart):
        conf = 'key: value\n'

        mtty.return_value = False
    ...
    @patch('sys.stdin.read')
    @patch('sys.stdin.isatty')
    def test_snapshot_without_conf(self, mtty, mread, mbar, mstart):
        mtty.return_value = True

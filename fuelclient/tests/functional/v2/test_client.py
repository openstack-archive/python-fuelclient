...
from fuelclient.tests.functional.base import CLIv2TestCase


class TestDeployChanges(CLIv2TestCase):
    ...
    pattern_success = "Deployment task with id (\d{1,}) " \
                      "for the environment 1 has been started.\n"

...
class RoleClient(base_v1.BaseV1Client):
    ...
    def update(self, release_id, role_name, data):
        return self._entity_wrapper.update(release_id, role_name, data)

    def create(self, release_id, data):
        return self._entity_wrapper.create(release_id, data)

...
#    WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See th    License for the specific language governing permissions and limitations
#    under the License.
...
class TagClient(base_v1.BaseV1Client):
    ...
    def update(self, data, tag_id):
        return self._entity_wrapper.update(tag_id, data)
